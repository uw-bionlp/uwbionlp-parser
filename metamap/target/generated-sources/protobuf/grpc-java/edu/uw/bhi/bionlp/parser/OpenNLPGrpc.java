...
public final class OpenNLPGrpc {
  ...
  public static final String SERVICE_NAME = "uwbionlp.parser.OpenNLP";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionInput,
      edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionOutput> METHOD_DETECT_SENTENCES =
      io.grpc.MethodDescriptor.<edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionInput, edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionOutput>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "uwbionlp.parser.OpenNLP", "DetectSentences"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionInput.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionOutput.getDefaultInstance()))
  ...
  public static abstract class OpenNLPImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void detectSentences(edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionInput request,
        io.grpc.stub.StreamObserver<edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionOutput> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionInput,
                edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionOutput>(
  ...
  public static final class OpenNLPBlockingStub extends io.grpc.stub.AbstractStub<OpenNLPBlockingStub> {
    ...
    /**
     */
    public edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionOutput detectSentences(edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionInput request) {
  ...
  public static final class OpenNLPFutureStub extends io.grpc.stub.AbstractStub<OpenNLPFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionOutput> detectSentences(
        edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionInput request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DETECT_SENTENCES:
          serviceImpl.detectSentences((edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionInput) request,
              (io.grpc.stub.StreamObserver<edu.uw.bhi.bionlp.parser.Uwbionlp.SentenceDetectionOutput>) responseObserver);
          break;
        default:
