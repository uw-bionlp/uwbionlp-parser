...
public final class MetaMapGrpc {
  ...
  public static final String SERVICE_NAME = "uwbionlp.parser.MetaMap";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapInput,
      edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapOutput> METHOD_EXTRACT_NAMED_ENTITIES =
      io.grpc.MethodDescriptor.<edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapInput, edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapOutput>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "uwbionlp.parser.MetaMap", "ExtractNamedEntities"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapInput.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapOutput.getDefaultInstance()))
  ...
  public static abstract class MetaMapImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void extractNamedEntities(edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapInput request,
        io.grpc.stub.StreamObserver<edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapOutput> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapInput,
                edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapOutput>(
  ...
  public static final class MetaMapBlockingStub extends io.grpc.stub.AbstractStub<MetaMapBlockingStub> {
    ...
    /**
     */
    public edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapOutput extractNamedEntities(edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapInput request) {
  ...
  public static final class MetaMapFutureStub extends io.grpc.stub.AbstractStub<MetaMapFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapOutput> extractNamedEntities(
        edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapInput request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXTRACT_NAMED_ENTITIES:
          serviceImpl.extractNamedEntities((edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapInput) request,
              (io.grpc.stub.StreamObserver<edu.uw.bhi.bionlp.parser.Uwbionlp.MetaMapOutput>) responseObserver);
          break;
        default:
