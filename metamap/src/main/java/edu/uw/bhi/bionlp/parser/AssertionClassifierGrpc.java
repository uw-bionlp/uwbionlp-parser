...
public final class AssertionClassifierGrpc {
  ...
  public static final String SERVICE_NAME = "uwbionlp.parser.AssertionClassifier";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierInput,
      edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierOutput> METHOD_PREDICT_ASSERTION =
      io.grpc.MethodDescriptor.<edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierInput, edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierOutput>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "uwbionlp.parser.AssertionClassifier", "PredictAssertion"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierInput.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierOutput.getDefaultInstance()))
  ...
  public static abstract class AssertionClassifierImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void predictAssertion(edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierInput request,
        io.grpc.stub.StreamObserver<edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierOutput> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierInput,
                edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierOutput>(
  ...
  public static final class AssertionClassifierBlockingStub extends io.grpc.stub.AbstractStub<AssertionClassifierBlockingStub> {
    ...
    /**
     */
    public edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierOutput predictAssertion(edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierInput request) {
  ...
  public static final class AssertionClassifierFutureStub extends io.grpc.stub.AbstractStub<AssertionClassifierFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierOutput> predictAssertion(
        edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierInput request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PREDICT_ASSERTION:
          serviceImpl.predictAssertion((edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierInput) request,
              (io.grpc.stub.StreamObserver<edu.uw.bhi.bionlp.parser.Uwbionlp.AssertionClassifierOutput>) responseObserver);
          break;
        default:
